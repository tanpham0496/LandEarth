...
const { bloodDB, landLogDB, bloodGameDB, bloodChatDB } = require('../db');
const { connectHost, connectDbLandLog, connectDbGame, connectDbChat } = require('./config');

connectDB(bloodDB, connectHost);
connectDB(landLogDB, connectDbLandLog);
connectDB(bloodGameDB, connectDbGame);
connectDB(bloodChatDB, connectDbChat);
...
module.exports = {
    ...
    Message: bloodChatDB.model('Message', require('../containers/messages/models/messages')),
    Room: bloodChatDB.model('Room', require('../containers/rooms/models/rooms')),
