...
import {updateImageUser} from "../../../../store/actions/commonActions/userActions";
...
class ProfileMain extends PureComponent {
    ...
    //     localStorage.setItem('_imageUserCache', nextState.imagePreviewUrl)
    // }
    onImageUpload = (e) => {
        ...
        if(image) {
            ...
            if( image.type === "image/jpeg"  ||  image.type === 'image/png' ) {
                reader.onloadend = () => {
                    this.setState({
                        file: image,
                        imagePreviewUrl: imageSize < 1 ? reader.result : null,
    ...
    render() {
        ...
        const {imagePreviewUrl,imageSizeVal, avatar, imageTypeVal} = this.state;
                    ...
                    <CardBody className='profile__card'>
                        <div className='profile__information'>
                            <div className='profile__avatar'>
                                ...
                                <img src={imagePreviewUrl ? imagePreviewUrl : imageUserCache ? imageUserCache : `data:image/jpeg;base64, ${avatar ? avatar.data : ''}`} alt='avatar' />
                            </div>
